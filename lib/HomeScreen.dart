...
class _HomeScreenState extends State<HomeScreen> {
  final pages = [
    ContentView(
      contentBackgroundColor: Colors.blue.shade700,
      imageUrl: 'assets/linkedin.png',
      title: 'Linked In',
      subTitle:
          'LinkedIn is a professional networking platform that allows individuals to connect with colleagues, employers, and other '
    ...
    ContentView(
      contentBackgroundColor: Colors.green.shade700,
      imageUrl: 'assets/whatsapp.png',
      title: 'WhatsApp',
      subTitle:
          'WhatsApp is a popular messaging application that allows users to send text messages, voice messages, multimedia files '
          '(such as photos and videos), and make voice and video calls. Here are some key features and information about WhatsApp:',
    ),

    ContentView(
      contentBackgroundColor: Colors.red.shade700,
      imageUrl: 'assets/youtube.png',
      title: 'YouTube',
      subTitle:
          ' Users can access YouTube through web browsers or the official mobile apps for iOS and Android. YouTube has become a '
          'significant platform for entertainment, education, and information, with billions of users around the world. ',
    ),

    ContentView(
      contentBackgroundColor: Colors.yellow.shade700,
      imageUrl: 'assets/snapchat.png',
      title: 'Snapchat',
      subTitle:
          'Snapchat is primarily a mobile app available for iOS and Android devices. It has been popular among younger users for its '
    ...
    ContentView(
      ...
      subTitle:
          "Join our community! Follow & Subscribe now for these type of videos and be part of THECODEME. "
